...
---
*Instructions:*
Please read all of the instructions before you start solving.

* The exam will be 4 hours long. Those who have extra time will receive it accordingly. 

* Code that throws an error will be graded 0. your code will be evaluated first by its output, and then by efficiency and clarity. 

* In every section you can assume that the output of the last section's code is correct, in order to use it in your code.

* The exam is built of 3 questions, 2 first question are 30 points each, third question is 40. 

* Don't put a path inside your code, use setwd(r"(<your_path>)") to a test path on the PC.

* Some of the questions have skeleton code, you can choose to use it or not. 

* Finally, send your solution in RMD and HTML (using Knit) formats in the tests server. 

* The name of your files should be <your_ID>_R_A.Rmd and <your_ID>_R_A.HTML
